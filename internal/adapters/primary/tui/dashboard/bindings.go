...
var (
	...
	sessionsKeyBindings     = []key.Binding{newSessionKeyBinding, attachShellKeyBinding, attachAgentKeyBinding, openEditorKeyBinding, deleteSessionKeyBinding, inspector.NextViewKeyBinding, inspector.PrevViewKeyBinding, nextPaneKeyBinding, helpMenuKeyBinding, quitKeyBinding}
