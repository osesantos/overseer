...
[![Tests](https://github.com/osesantos/overseer/actions/workflows/build.yaml/badge.svg)](https://github.com/osesantos/overseer/actions/workflows/build.yaml)
...
```bash
go install github.com/osesantos/overseer/cmd/overseer@latest
```
...
```bash
git clone https://github.com/osesantos/overseer.git
cd overseer
make build
```
...
Quick links:
- [Bug Reports](https://github.com/osesantos/overseer/issues/new?template=bug_report.md)
- [Feature Requests](https://github.com/osesantos/overseer/issues/new?template=feature_request.md)
- [Pull Requests](https://github.com/osesantos/overseer/pulls)
