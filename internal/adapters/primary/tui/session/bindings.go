...
var (
	...
	popupArrowUpKeyBinding          = key.NewBinding(key.WithKeys("up"), key.WithHelp("↑", "prev field"))
	popupArrowDownKeyBinding        = key.NewBinding(key.WithKeys("down"), key.WithHelp("↓", "next field"))
